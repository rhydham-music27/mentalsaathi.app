...
export default function CommunityPage() {
  ...
  return (
    <>
      <Head>
        <title>Join Mental Saathi – A Student Mental Health Community</title>
        <meta
          name="description"
          content="Join Mental Saathi’s supportive mental health community designed for students seeking a safe and stigma-free space.
"
        />
        <meta
          name="keywords"
          content="student mental health community, peer support India, join mental wellness group, safe mental health space, inclusive youth support, emotional wellbeing group, connect mental support
"
        />
