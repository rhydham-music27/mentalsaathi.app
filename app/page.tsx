...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Mental Saathi – Student Mental Wellness Platform India</title>
        <meta
          name="description"
          content="Mental Saathi is a student-led wellness platform offering peer support, journaling, and a safe space for mental health.
."
        />
        <meta
          name="keywords"
          content="student mental wellness platform, youth mental health support, mental health platform India, safe space for mental health, peer support, journaling for students, emotional well-being, mindfulness for students, mental health India, stress relief tools"
        />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Comprehensive support designed specifically for Indian
                university students
              </p>
            </div>
